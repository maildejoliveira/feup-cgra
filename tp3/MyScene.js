...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.9,0.7,0.5,1.0);
    ...
    display() {
        ...
        //Change global ambient light (according to manageAmbientLight)
        this.setGlobalAmbientLight(this.manageAmbientLight,this.manageAmbientLight,this.manageAmbientLight,1);
