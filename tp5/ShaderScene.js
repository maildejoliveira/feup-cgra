...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/ex_1.vert","shaders/ex_1.frag"),
			new CGFshader(this.gl, "shaders/texture1.vert","shaders/ex_3.frag"),
		...
		this.testShaders[11].setUniformsValues({ uSampler3: 3, uSampler4: 4, timeFactor: 0 });
